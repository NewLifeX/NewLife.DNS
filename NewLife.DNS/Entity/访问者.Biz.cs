...
{
    /// <summary>访问者</summary>
    public partial class Visitor : Entity<Visitor>
    {
        #region 对象操作﻿
        static Visitor()
        {
            var sc = Meta.SingleCache;
            sc.FindKeyMethod = k => Find(_.Name, k);
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}访问者数据……", typeof(Visitor).Name);

        //    var entity = new Visitor();
        //    entity.Name = "abc";
        //    entity.Hits = 0;
        //    entity.LastDomainName = "abc";
        //    entity.LastVisit = DateTime.Now;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}访问者数据！", typeof(Visitor).Name);
        //}
        ...
        //public static EntityList<Visitor> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        //{
